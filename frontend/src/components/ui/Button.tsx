...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-full font-medium transition-colors duration-150 disabled:opacity-40 disabled:pointer-events-none whitespace-nowrap",
  {
    variants: {
      variant: {
        primary: "bg-[var(--color-plum)] text-white hover:bg-[var(--color-plum-dark)]",
        secondary: "bg-[var(--color-teal)] text-[var(--color-plum-dark)] hover:bg-[var(--color-teal-dark)] hover:text-white",
