...
from ai.agents.coach.routing import route_after_intervention, route_after_validation
...
def build_coach_graph(
    ...
    graph.add_edge("understand_context", "diagnose")
...
class Coach:
    ...
    def __init__(
        ...
        self._graph = build_coach_graph(course_tool, history_tool).compile()
